...
为 jojo-Code 项目添加了三类强大的新工具，扩展了编码 Agent 的能力：

### 1. 代码分析工具 (`src/jojo_code/tools/code_analysis_tools.py`)
...
### 2. Git 集成工具 (`src/jojo_code/tools/git_tools.py`)
...
### 3. 性能分析工具 (`src/jojo_code/tools/performance_tools.py`)
...
### 新增文件
- `src/jojo_code/tools/code_analysis_tools.py` - 代码分析工具
- `src/jojo_code/tools/git_tools.py` - Git 集成工具
- `src/jojo_code/tools/performance_tools.py` - 性能分析工具
...
### 修改文件
- `src/jojo_code/tools/registry.py` - 注册新工具到系统
...
这些工具为 jojo-Code 项目奠定了坚实的基础，可以轻松扩展：
- 更多代码质量检查规则
...
**这个 PR 显著增强了 jojo-Code 的功能，使其成为一个更全面的编码助手！** 🎉