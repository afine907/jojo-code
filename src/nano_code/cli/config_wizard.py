...
# 支持的 API 提供商
PROVIDERS = {
    "1": {"name": "OpenAI", "base_url": "https://api.openai.com/v1", "models": ["gpt-4o", "gpt-4o-mini", "gpt-4-turbo", "gpt-3.5-turbo"]},
    "2": {"name": "OpenRouter", "base_url": "https://openrouter.ai/api/v1", "models": ["auto", "anthropic/claude-3.5-sonnet", "openai/gpt-4o"]},
    "3": {"name": "Azure OpenAI", "base_url": None, "models": ["gpt-4o", "gpt-4o-mini"]},
    "4": {"name": "LongCat", "base_url": "https://api.longcat.ai/v1", "models": ["gpt-4o", "gpt-4o-mini"]},
...
class ConfigWizard:
    ...
    def _prompt_base_url(self) -> Optional[str]:
        """提示输入 Base URL"""
        console.print(f"\n[bold]请输入 {self.provider} API Base URL[/bold]")
        console.print("[dim]示例: https://your-resource.openai.azure.com/openai/deployments/your-deployment[/dim]")
